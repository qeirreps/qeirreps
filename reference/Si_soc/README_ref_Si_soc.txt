...
Here, qeirreps/reference/Si_soc is the directory which stores the output files for DFT calculation of Si with spin-orbit coupling.
...
1-6. z4.dat:
     The value of Z4 index defined from the sum of inversion parties of occupied bands at all TRIMs.
