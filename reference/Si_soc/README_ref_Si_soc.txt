...
Here, qeirreps/reference/Si_soc is the directory which stores the output files for DFT calculation of silicon with spin-orbit coupling.

See also qeirreps/example/Si_soc to test the calculation processes.
...
Check detailed information in example/Si_soc
...
This contains Si.rep.in, Si.rep.out, dir-wfn, output, and qeirreps.log.
Si.rep.in has a different choice of k-points to export an input file of CheckTopologicalMat. Si.rep.out is the log file of nscf calculations.
