...
Here, qeirreps/reference/NaCdAs_soc is the directory which stores the output files for DFT calculation of NaCdAs with spin-orbit coupling.

See also qeirreps/example/NaCdAs_soc to test the calculation processes.
...
Check detailed information in example/NaCdAs_soc
...
This contains NaCdAs.rep.in, NaCdAs.rep.out, dir-wfn, output, and qeirreps.log.
