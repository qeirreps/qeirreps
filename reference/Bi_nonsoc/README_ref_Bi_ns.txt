...
Here, qeirreps/reference/Bi_nonsoc is the directory 
which stores the output files for DFT calculation of bismuth
without spin-orbit coupling.

See also qeirreps/example/Bi_nonsoc to confirm the detail of input files.
...
2. For Mathematica usage, "*_import.txt"
   ...
   See and edit the Mathematica notebook file (i.e., "example/Bi_nonsoc/Bi.nb")
