...
Here, qeirreps/reference/Bi_nonsoc is the directory which stores the output files for DFT calculation of bismuth without spin-orbit coupling.

See also qeirreps/example/Bi_nonsoc to test the calculation processes.
