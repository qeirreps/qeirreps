...
Here, qeirreps/reference/PbPt3_soc is the directory which stores the output files for DFT calculation of PbPt3 with spin-orbit coupling.

See also qeirreps/example/PbPt3_soc to test the calculation processes.
...
Check detailed information in qeirreps/example/PbPt3_soc
