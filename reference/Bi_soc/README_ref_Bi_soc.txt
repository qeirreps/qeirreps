...
Here, qeirreps/reference/Bi_soc is the directory 
which stores the output files for DFT calculation of bismuth
without spin-orbit coupling.

See also qeirreps/example/Bi_soc to confirm the detail of input files.
...
Check detailed information in qeirreps/example/Bi_soc
...
The result files of nscf calculation with input "Bi.band.in" and "Bi.bands.in"
You can plot the band structure by gnuplot from "Bi.band.gnu".
...
2. For Mathematica usage, "*_import.txt"
   ...
   See and edit the Mathematica notebook file (i.e., "example/Bi_soc/Bi.nb")
