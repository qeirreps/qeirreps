...
Here, qeirreps/reference/Si_nonsoc is the directory 
which stores the output files for DFT calculation of silicon
without spin-orbit coupling.

See also qeirreps/example/Si_nonsoc to confirm the detail of input files.
...
Check detailed information in qeirreps/example/Si_nonsoc
...
2. For Mathematica usage, "*_import.txt"
   ...
   See and edit the Mathematica notebook file (i.e., "example/Si_nonsoc/Si.nb")
