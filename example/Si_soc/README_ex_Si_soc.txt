...
This directory also has Si.rep.in and output.
The input file Si.rep.in has a different choice of k-points.
...
4. Calculation of the character tables and Z4 index by qeirreps
   ...
   Run qeirreps by typing as follows.
	...
	$ ../../src/qeirreps.x . 8 z4 > qeirreps.log
...
5. Exporting the input file for CheckTopologicalMat
   ...
   Run qeirreps by typing as follows.
	...
	$ ../../../src/qeirreps.x . 8 ctm > qeirreps.log
