...
Here, qeirreps/example/Si_soc is the directory 
...
4-2. Calculation of the sum of inversion parties for all TRIMs
   ...
   where "../../src/" is the location of the qeirreps executable file,
   "." is the current directory "Si_soc" which contains "dir-wfn" and "output",
   "qeirreps.log" is the log file of standard output,
   and "8" is the filling of silicon

   A filling is defined as the number of electrons per unit cell.
   You can find the filling in the log file of QE (i.e. /example/Si_soc/Si.rep.out)
   like "number of electrons = 8.00"

   This filling should be an integer number in qeirreps
