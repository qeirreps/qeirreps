...
Here, qeirreps/example is the directory 
which stores some input files for QE as examples.

See also qeirreps/reference to confirm the results.
...
See each example directory for detailed information 
about input files and calculation processes
