...
This directory also has Bi.rep.in and output.
The input file Bi.rep.in has a different choice of k-points.  
...
4. Calculation of the character tables and Z4 index by qeirreps
   ...
   Run qeirreps by typing as follows.
	...
	$ ../../src/qeirreps.x . 30 z4 > qeirreps.log
...
5. Exporting the input file for CheckTopologicalMat
   ...
   (e.g., cp -r ../work/scf/* ./work/rep/)
   The input file Bi.rep.in has a different choice of k-points, which is suitable for CheckTopologicalMat.   

   Run qe2respack as described in step 3.

   Run qeirreps by typing as follows.

	$ ../../../src/qeirreps.x . 30 ctm > qeirreps.log
